  ...
  $('#mainMenuWrapper').prepend(
    `<div class="ui small inverted borderless menu" style="height:12px">
            ...
            <div class="ui container" id="mainMenu">
                ...
                <a class="item" href="#" data-history="dast">DAST</a>
...
<div class="ui success tiny message" id="ptk_release_note" style="display:none;position: absolute;bottom: 0;right: 0;z-index: 2;margin:0; width:500px">
  ...
  <ul class="list">
    <li><strong>DAST Analysis & Coverage:</strong> Added new tabs to highlight the most interesting manual-testing candidates and show which engines contributed evidence for the same host/session.</li>
    <li><strong>IAST buckets:</strong> Added grouped client-side attack-surface views such as <strong>Execution</strong>, <strong>Authz/State</strong>, and <strong>Data/Storage</strong> to make runtime results easier to review.</li>
    <li><strong>SAST buckets:</strong> Added grouped code-review views such as <strong>Routes</strong>, <strong>Endpoints</strong>, <strong>Params</strong>, and <strong>Gadgets</strong> to surface the most useful code artifacts faster.</li>
    <li><strong>UI, export/import, and stability:</strong> Improved evidence presentation, R-Builder handoff, scan management progress, cross-engine coverage, and overall stability and responsiveness.</li>
  </ul>
